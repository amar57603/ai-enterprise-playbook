...
### Method 1: Agentic Auto-Install (Zero-Touch)
If you are using an autonomous agent (like Antigravity, Cline, or Aider), you don't need to download anything manually. Just paste this exact prompt into your chat and the agent will install the skill itself:
...
### Method 2: AI IDEs (Cursor, Windsurf, PearAI)
...
### Method 3: VS Code Extensions (GitHub Copilot, Roo Code, Continue.dev)
If you are using Copilot Workspace or VS Code extensions like Roo/Cline, they rely on workspace instructions.
1. Compile the rules into a single file using the commands from Method 2.
...
### Method 4: Web-Based AI (ChatGPT Pro, Claude Projects, Lovable, v0)
...
### Method 5: CLI Autonomous Agents (Aider, Devin, OpenDevin)
...
### Method 6: Gemini / Antigravity Global Skills (Advanced)
